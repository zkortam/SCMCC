...
class CreateEventsWidget extends StatefulWidget {
  const CreateEventsWidget({super.key});

  @override
  State<CreateEventsWidget> createState() => _CreateEventsWidgetState();
}
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          'Start Time: ${valueOrDefault<String>(
                                                            dateTimeFormat(
                                                              "M/d h:mm a",
                                                              _model
                                                                  .datePicked1,
                                                ...
                                                onTap: () async {
                                                  final datePicked2Date =
                                                    ...
                                                    initialDate: ((_model.datePicked1 ?? getCurrentTimestamp) ??
                                                        DateTime.now()),
                                                    firstDate: ((_model.datePicked1 ?? getCurrentTimestamp) ??
                                                        DateTime.now()),
                                                    lastDate: DateTime(2050),
                                                    builder: (context, child) {
                                                      return wrapInMaterialDatePickerTheme(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          'End Time: ${valueOrDefault<String>(
                                                            dateTimeFormat(
                                                              "M/d h:mm a",
                                                              _model
                                                                  .datePicked2,
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          'RSVP By Time: ${valueOrDefault<String>(
                                                            dateTimeFormat(
                                                              "M/d h:mm a",
                                                              _model
                                                                  .datePicked3,
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    hintText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      'tb6ov474' /* Mandatory Link (If Applicable) */,
                                                    ),
                                                    hintStyle: FlutterFlowTheme
                                                            .of(context)
                                                        .bodyLarge
