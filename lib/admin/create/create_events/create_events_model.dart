...
import 'create_events_widget.dart' show CreateEventsWidget;
import 'package:flutter/material.dart';

class CreateEventsModel extends FlutterFlowModel<CreateEventsWidget> {
  ...
  // Stores action output result for [Backend Call - Create Document] action in Publish widget.
  EventsRecord? out;
