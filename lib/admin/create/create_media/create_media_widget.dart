...
class CreateMediaWidget extends StatefulWidget {
  const CreateMediaWidget({super.key});

  @override
  State<CreateMediaWidget> createState() => _CreateMediaWidgetState();
}
                                      ...
                                      _model.output =
                                          MediaRecord.getDocumentFromData(
                                              createMediaRecordData(
                                                ...
                                                category: _model.dropDownValue2,
                                                clicksInt: 0,
                                                isShow: _model.dropDownValue1 ==
                                                        'Movie'
                                                    ? false
                                                    : true,
                                              ),
                                              mediaRecordReference);
                                      if (_model.dropDownValue1 == 'Movie') {
                                        context.goNamed('Media');
                                      } else {
                                        context.goNamed(
                                          'createEpisode',
                                          queryParameters: {
