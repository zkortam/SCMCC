...
import 'create_jobs_model.dart';
export 'create_jobs_model.dart';

class CreateJobsWidget extends StatefulWidget {
  const CreateJobsWidget({super.key});

  @override
  State<CreateJobsWidget> createState() => _CreateJobsWidgetState();
}

class _CreateJobsWidgetState extends State<CreateJobsWidget>
    with TickerProviderStateMixin {
  late CreateJobsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateJobsModel());
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              'Application Due Date: ${dateTimeFormat(
                                                "M/d h:mm a",
                                                _model.datePicked,
                                                locale:
