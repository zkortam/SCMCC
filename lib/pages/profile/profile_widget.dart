                                  ...
                                  if (_model.userRefState !=
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        height: 50.0,
                                        decoration: BoxDecoration(
                                          color: const Color(0x93FCDC0C),
                                          borderRadius:
                                              BorderRadius.circular(40.0),
                                          border: Border.all(
                                            color: const Color(0xC9FCDC0C),
                                            width: 5.0,
                                          ),
                                        ),
                                        child: Padding(
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                height: 50.0,
                                                decoration: BoxDecoration(
                                                  color: const Color(0x5C179A86),
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          40.0),
                                                  border: Border.all(
                                                    color: const Color(0xC0179A86),
                                                    width: 5.0,
                                                  ),
                                                ),
                                                child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await launchUrl(Uri(
                                      ...
                                      query: {
                                        'subject': 'Contacting you from SCMCC',
                                      }
                                          .entries
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'm5qtrwnc' /* Contact Administrators */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
