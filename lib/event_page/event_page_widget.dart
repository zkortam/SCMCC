            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<EventsRecord>(
                  stream: EventsRecord.getDocument(widget.id!),
                    ...
                    return Column(
                      ...
                      children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          '${columnEventsRecord.pointValue.toString()} Points',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Montserrat',
                                        ...
                                        Text(
                                          '${columnEventsRecord.registrants.length.toString()} Registrants',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Montserrat',
                        ...
                        if (functions.isUserRegistered(currentUserReference!,
                            columnEventsRecord.registrants.toList()))
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 0.0),
                            child: Container(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '224dff2w' /* You have Registered for this E... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
